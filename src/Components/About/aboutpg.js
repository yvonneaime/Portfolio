    ...
    return (
        <div className="container mx-auto p-10">
            ...
            <div className="flex flex-col md:flex-row p-4 mb-8">
                <img src="/aboutprofile.jpg" alt="Profile Image" className="w-84 h-84 md:w-96 md:h-96 object-cover rounded-full border-4 border-gray-400 shadow-2g mb-4 md:mb-0 md:mr-8" />
