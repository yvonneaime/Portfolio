const Bio = () => {
    ...
    return (
      <div className="p-8 px-18 py-10">
        <div className="p-4 flex flex-col md:flex-row items-center space-x-2 mb-12">
          ...
          <div className="text-xl mt-4 md:mt-0">
            ...
            <p className="mb-4">I'm a UI/UX Designer with over two years experience conceptualizing and crafting digital products, helping businesses
             and non-profits expand their capacity for impact  🚀</p>
            <p className="mb-4"> 🟡</p>
